...
const BODY = <div className="w-[10px] h-[100px] bg-black absolute top-[120px] right-0"></div>;
...
const RIGHT_LEG = <div className="w-[100px] h-[10px] bg-black absolute top-[210px] right-[-90px] rotate-[60deg] origin-bottom-left"></div>;

const LEFT_LEG = <div className="w-[100px] h-[10px] bg-black absolute top-[210px] right-0 rotate-[-60deg] origin-bottom-right"></div>;
...
export function HangmanDrawing({ numberOfGuesses }: HangmanDrawingProps) {
  return (
    <div className="relative">
      ...
      <div className="h-[10px] w-[220px] bg-black ms-[120px]" />
